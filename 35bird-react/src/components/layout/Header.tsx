  ...
  return (
    <header className="header fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border" role="banner">
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav className="header__nav flex items-center gap-6" role="navigation" aria-label="Main navigation">
          <Button variant="ghost" size="icon" aria-label="Version history">
            <History className="w-5 h-5" />
          </Button>
          
          <a href="#projects" className="header__nav-link text-foreground hover:text-primary transition-colors">
            Projects
          </a>
          
          <a href="#info" className="header__nav-link text-foreground hover:text-primary transition-colors">
            Info
          </a>
          
          <a href="#contact" className="header__nav-link text-foreground hover:text-primary transition-colors">
            Contact
          </a>
